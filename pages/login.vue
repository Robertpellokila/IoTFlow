    ...
    <div class="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-br from-background-card to-background relative overflow-hidden">
      ...
      <div class="relative z-10 space-y-6">
        <h1 class="text-4xl font-bold text-white leading-tight">
          Build Your IoT Dashboard Without Building It From Scratch.
        </h1>
        <p class="text-slate-400 text-lg">
          Connect your ESP32, add widgets, monitor sensors, and control your devices from one simple dashboard.
        </p>
      ...
      <div class="relative z-10 text-sm text-slate-500">
        Trusted by students and makers worldwide
      </div>
    </div>
    ...
    <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
      <div class="w-full max-w-md">
        ...
        <div class="mb-8">
          ...
          <p class="text-slate-400">Sign in to your IoTFlow account</p>
        </div>
...
import { Radio, Eye, EyeOff, Loader2 } from 'lucide-vue-next'
